...
optimized images using photoshop

ran critical to place necessary CSS below the fold

ran gulp-htmlmin to minimize html to achieve a better than 90 pagespeed insight score

####Part 2: Optimize Frames per Second in pizza.html

ran through developer tools again and again to find bottlenecks. ended up changing an awful lot to acheive necesarry fps.

modified resize pizzas slider to be more efficient

changed random pizza container
